...
<body class="h-[99.8vh] w-full flex flex-col justify-center items-center overflow-hidden colorback">
    ...
    <main class="h-full w-full flex flex-row">
       ...
       <section class="ml-10 w-full flex flex-col items-center gap-10">
            {{-- isi di sini --}}
            <div class=" h-24 flex flex-row justify-center items-center">
                <h1 class="font-bold text-2xl font-sans">Home</h1>
            </div>
            <div class="grid h-5/9 grid-cols-2 place-content-center gap-30">
                <div class="flex items-center justify-between w-[350px] h-[150px] bg-[#D9D9D9] rounded-2xl p-4">
                    <div>
                    <div class="text-xl font-bold">ANTRIAN HARIAN</div>
                    <div class="text-2xl text-center font-bold">{{ $que_today }}</div>
                    </div>
                <img src="{{ asset('aset/tickets.png') }}" alt="" class="w-12 h-12" />
                </div>
                <div class="flex items-center justify-between w-[350px] h-[150px] bg-[#D9D9D9] rounded-2xl p-4">

                     <img src="{{ asset('aset/tickets.png') }}" alt="" class="w-12 h-12" />
                     <div>
                    <div class="text-xl font-bold">ANTRIAN TOTAL</div>
                    <div class="text-2xl text-center font-bold">{{ $que_all }}</div>
                    </div>
                </div>

                <div class="flex items-center justify-between w-[350px] h-[150px] bg-[#D9D9D9] rounded-2xl p-4">
                    <div>
                    <div class="text-xl font-bold">JUMLAH LOCKET</div>
                     <div class="text-2xl text-center font-bold">{{$loket}}</div>
                    </div>
                <img src="{{ asset('aset/costumer-service.png') }}" alt="" class="w-12 h-12" />
                </div>
                 <div class="flex items-center justify-between w-[350px] h-[150px] bg-[#D9D9D9] rounded-2xl p-4">
