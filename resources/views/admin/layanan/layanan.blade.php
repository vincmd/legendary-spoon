    ...
    <main class="h-full w-full flex flex-row">
        ...
        <section class="ml-10 w-full flex flex-col items-center">
            ...
            <div class=" h-12 flex flex-row justify-center items-center">
                <h1 class="font-bold text-2xl font-sans">services</h1>
            </div>
                ...
                <table class="table w-35/36 h-auto ">
                    <thead class="bgcolormain w-full h-8 ">
                        <tr>
                            ...
                            <th class="border border-black text-lg colormain">services</th>
                            <th class="border border-black text-lg colormain">code /alias</th>
                            <th class="border border-black text-lg colormain">logo</th>
